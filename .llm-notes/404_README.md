...
A simple and user-friendly 404 error page for the Next.js Forge application.
...
- `Button` - "Back to Forge Home" call-to-action button
...
- **Home Button**: Takes users back to the main Forge page (`/`)
...
1. **Change Button Text**: Update "Back to Forge Home" to your preference
