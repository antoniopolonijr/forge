# Forge API Routes Documentation

Stub API routes for the Next.js Forge application using App Router format. These are mock implementations for development and learning purposes.
...
- **Article 1**: "Welcome to ForgeFlow" - Getting started guide
- **Article 2**: "Markdown Guide" - How to write in Markdown
- **Article 3**: "Advanced Features" - Advanced Forge features
